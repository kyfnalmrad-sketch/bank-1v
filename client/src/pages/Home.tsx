  ...
  return (
    <div key={selectedBank} className="app-shell" dir="rtl">
      ...
      {activeTab === "fastStatement" && selectedBank === "tadhamon" && <section className="panel print-preview-panel" dir="rtl">
        ...
        <div className="document-frame-wrap"><iframe key={`quick-preview-${fastRowsPerPage}-${tadhamonFastStatementHtml.length}`} className="document-frame" title="Tadhamon quick account statement preview" srcDoc={tadhamonFastStatementHtml} /></div>
      </section>}
