...
const qrPayload = [
  ...
  "DOC=STMT",
  "P=1/1",
  "N=Ahmed Mohammed Al-Qahtani",
  "PP=P1234567",
  "A=Sana'a - Bab Al-Yemen",
  "B=AL-ZUBAIRI",
  "AC=101-840-21102-326491-000",
  "C=USD",
  "T=05-Feb-2025-24-Jun-2025",
  "D=24-Jun-2025",
  "R1=0379297",
  "RN=0379302",
  "O=6",
...
const qr = await QRCode.toDataURL(qrPayload, { width: 620, margin: 4, errorCorrectionLevel: "H", color: { dark: "#2d3192", light: "#ffffff" } });
...
html = html.replace("</head>", "<style>.address-qr{width:20mm!important;height:20mm!important;image-rendering:crisp-edges;image-rendering:-webkit-optimize-contrast}.title-pdf417{width:52mm!important;height:10mm!important;object-fit:fill!important}.page{padding-top:3.2mm}.top{height:68mm!important}.summary{margin-top:3mm!important}.table{margin-top:3mm!important}.notes{margin-top:3mm!important}</style></head>");
