...
function header(profile: TadhamonFastStatementProfile, style = "") {
  return `<section class="top-info"${style}><div class="info-box account-number-box" style="grid-column:1 / span 4"><span class="info-label">Account Number<span class="ar">رقم الحساب</span></span><span class="info-value account-number-value">${esc(profile.accountNumber)}</span></div><div class="info-box opening-balance-box" style="grid-column:5 / span 2"><span class="info-label" style="font-size:6.8pt">Opening Balance<span class="ar" style="font-size:6.2pt">الرصيد الافتتاحي</span></span><span class="info-value">${money(profile.openingBalance)}</span></div><div class="info-box" style="grid-column:7"><span class="info-label">Account Opening Date<span class="ar">تاريخ فتح الحساب</span></span><span class="info-value">${esc(profile.openingDate || profile.customerSince || "—")}</span></div></section>`;
}
