...
export function useAuth(options?: UseAuthOptions) {
  ...
  const loginMutation = trpc.auth.login.useMutation({ onSuccess: () => { void meQuery.refetch(); } });
  ...
  }), [loginMutation.error, loginMutation.isPending, logoutMutation.error, logoutMutation.isPending, meQuery.data, meQuery.error, meQuery.isLoading]);
