...
.signature{text-align:center;font-size:12pt;line-height:1.35;color:#151b29;min-height:22mm;min-width:0}
...
.notice{position:absolute;bottom:29mm;left:16mm;right:16mm;text-align:center;font-size:8.5pt;line-height:1.3;color:#a30000}
...
<section class="page">
  ...
  <main class="content">
    ...
    <section class="body">
      <p>Yemen Commercial Bank presents its compliments and wishes you continued success. We hereby confirm that our client, <span class="strong">[CUSTOMER_NAME]</span>[PASSPORT_LINE], holds a <span class="strong">[ACCOUNT_TYPE]</span> with us under account number <span class="strong">[ACCOUNT_NUMBER]</span>, with a total balance of <span class="strong">[BALANCE_NUMERIC] [CURRENCY]</span> as of <span class="strong">[AS_OF_DATE]</span>.[BIRTH_SENTENCE][PERIOD_SENTENCE]</p>
    </section>
