...
- عمودا التوقيع: شبكة مرنة بعمودين، مع رفع بسيط عن الموضع السابق من خلال `margin-top` مرن.
- التنبيه الأحمر السفلي: بقي على موضعه وحجمه السابقين عند `bottom: 30mm`، ولم يتم تحريكه بسبب رفع عمودي التوقيع.
