/**
 * Design reference: these preview documents preserve the layout rules of the
 * Prototype 0.5.1 templates while keeping all user supplied text HTML-escaped.
 */
