...
function AuthenticatedHome({ user, logout }: { user: { name?: string | null; email?: string | null }; logout: () => Promise<void> }) {
  ...
  useEffect(() => {
    ...
    const generated = values.map((value) => {
      const svg = bwipjs.toSVG({ bcid: "code128", text: value, scaleX: 2, scaleY: 3, padding: 6, includetext: true, textxalign: "center", backgroundcolor: "FFFFFF", barcolor: selectedBank === "ycb" ? "2D3192" : "6B5297" });
