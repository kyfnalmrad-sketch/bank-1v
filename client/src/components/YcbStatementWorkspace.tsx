...
function printHtml(html: string, profile: YcbStatementProfile) {
  return downloadDocumentPdf("accountStatement", html, profile.customerName, undefined, profile.branchName, profile.issueDate);
}
