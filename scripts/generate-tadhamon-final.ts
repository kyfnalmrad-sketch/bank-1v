...
const overrides = `<style>.page>.top{height:68mm!important}.top [style*="border-top:1px solid #d1d7dc"]{border-top:0!important;padding-top:0!important}.identity-field{border:1px solid #b7c1c8;padding:1.2mm 1.5mm;margin-bottom:1mm;background:rgba(255,255,255,.9)}.identity-field .field-label{display:block;font-weight:800;font-style:italic;text-transform:uppercase}.identity-field .field-value{display:block;margin-top:.7mm}.address-grid{display:grid;grid-template-columns:1fr 1fr;gap:2.5mm;margin-top:1mm}.address-grid .address-field{min-width:0;border:1px solid #b7c1c8;padding:1.2mm 1.5mm;background:rgba(255,255,255,.9)}.address-grid .field-label{display:block;font-weight:800;font-style:italic;text-transform:uppercase}.address-grid .field-value{display:block;margin-top:.7mm}.summary{grid-template-columns:repeat(4,1fr) 27mm!important;height:24mm!important}.code-sum{display:flex;align-items:center;justify-content:center;gap:1mm;padding:1mm;border-left:1px solid #b2bec7}.summary-qr{width:22mm;height:22mm;object-fit:contain}.row{grid-template-columns:13% 14% 43% 8% 8% 14%!important}.page>.summary{margin-top:3mm!important}.page>.table{margin-top:3mm!important}.page>.notes{margin-top:3mm!important}.row:nth-child(odd):not(.head):not(.total) .cell{background:#E2E6EA}.row.credit-row .cell{background:#E8F8F5;color:#1B365D}@media print{.page{margin:0!important}}</style>`;
