...
.header-meta{position:absolute;top:47mm;left:21mm;text-align:left;font-size:10pt;line-height:1.65;color:#172a63}
.header-meta div{white-space:nowrap}
.header-hijri{position:absolute;top:47mm;right:21mm;text-align:right;direction:rtl;font-size:10pt;line-height:1.65;color:#172a63}
.header-hijri div{white-space:nowrap}
.content{position:absolute;top:72mm;left:16mm;right:16mm}
.title{text-align:center;font-size:18pt;font-weight:700;letter-spacing:.2px;text-transform:uppercase;margin:9mm 0 12mm;padding:0}
...
.closing{font-size:16pt;font-weight:700;text-align:center;margin-top:14mm;color:#151b29}
.signatures{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);column-gap:24mm;margin:16mm 0 0}
...
<section class="page">
  ...
  <main class="content">
    ...
    <section class="body">
      ...
      <p>We, at Yemen Commercial Bank, hereby confirm that our client, <span class="strong">[CUSTOMER_NAME]</span>, holds a <span class="strong">[ACCOUNT_TYPE]</span> with us under account number <span class="strong">[ACCOUNT_NUMBER]</span> with a total bank balance of <span class="strong">[BALANCE_IN_WORDS] ([BALANCE_NUMERIC] [CURRENCY])</span> as of [AS_OF_DATE].</p>
    </section>
