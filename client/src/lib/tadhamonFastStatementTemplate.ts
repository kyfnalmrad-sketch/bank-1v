...
function row(item: YcbStatementTransaction, highlights: Record<string, string>) {
  ...
  const highlight = highlightColor ? ` highlight" style="--highlight-color:${highlightColor};--highlight-text-color:${highlightColor.toLowerCase() === "#000000" ? "#fff" : "#111"}` : "";
